...
package dio is
    ...
    package port1 is
        ...
        OutputRegister    : aliased uint8_t with volatile, address => System'To_Address(16#0202#);
        DirectionRegister : aliased uint8_t with volatile, address => System'To_Address(16#0204#);
